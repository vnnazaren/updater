...
public record DatabasePayload(@NotNull(groups = {Marker.OnUpdate.class})
                              ...
                              @Min(groups = {Marker.OnCreate.class, Marker.OnUpdate.class},
                                      value = 0,
                                      message = "Порт базы данных должен быть положительным числом.")
                              @Max(groups = {Marker.OnCreate.class, Marker.OnUpdate.class},
                                      value = 65536,
                                      message = "Порт базы данных может быть максимум 65536")
